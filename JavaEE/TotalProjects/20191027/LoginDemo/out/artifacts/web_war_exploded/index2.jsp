...
<div class='login'>
    ...
    <div class='login_fields'>
        <div class='login_fields__user'>
            ...
            <input name="userName" placeholder='用户名' maxlength="16" type="text" id="userName_id">
        ...
        <div class='login_fields__password'>
            ...
            <input name="userPassword" placeholder='密码' maxlength="16" type="password" id="userPassword_id">
            <div class='validation'>
                <img alt="" src='img/tick.png'>
            </div>
        </div>
